...
@register_tool(
    ...
    config={
        ...
        "description": (
            "Search Cellosaurus cell lines using the /search/cell-line "
            "endpoint. Supports Solr query syntax for precise field-based "
            "searches."
        ),
        "parameter": {
            "type": "object",
            "properties": {
                "q": {
                    "type": "string",
                    "description": (
                        "Search query. Supports Solr syntax for field-specific"
                        " searches (e.g., 'id:HeLa', 'ox:9606', 'char:cancer')"
                        ". See https://api.cellosaurus.org/api-fields for "
                        "available fields."
                    ),
                },
                "offset": {
            ...
            "properties": {
                ...
                "results": {
                    ...
                    "properties": {
                        "cell_lines": {
                            "type": "array",
                            "description": "List of matching cell lines",
                        },
                        "total": {
                            "type": "integer",
                            "description": ("Total number of matching cell lines"),
                        },
                        "offset": {
                            "type": "integer",
...
@register_tool(
    ...
    config={
        ...
        "description": (
            "Convert natural language queries to Solr syntax for Cellosaurus "
            "API searches. Uses semantic similarity to map terms to "
            "appropriate fields."
        ),
        "parameter": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": (
                        "Natural language query to convert to Solr syntax "
                        "(e.g., 'human cancer cells', 'HeLa cells from "
                        "lung tissue')"
                    ),
                },
                "include_explanation": {
                    "type": "boolean",
                    "description": (
                        "Whether to include detailed explanation of the "
                        "conversion process"
                    ),
                    "default": True,
                },
        ...
        "return_schema": {
            ...
            "properties": {
                ...
                "solr_query": {
                    "type": "string",
                    "description": "The converted Solr query",
                },
                "is_valid": {
                    "type": "boolean",
                    "description": "Whether the generated Solr query is valid",
                },
                "validation_message": {
                    "type": "string",
                    "description": "Validation message for the Solr query",
                },
                "explanation": {
                    "type": "object",
                    "properties": {
                        "extracted_terms": {
                            ...
                            "items": {
                                ...
                                "properties": {
                                    ...
                                    "match_reason": {
                                        "type": "string",
                                        "description": ("Reason for the field mapping"),
                                    },
                                },
                            },
                        },
                        "transformations_applied": {
                            ...
                            "items": {"type": "string"},
                            "description": (
                                "List of transformations applied to the query"
                            ),
                        },
                        "available_fields": {
                            "type": "array",
                            "items": {"type": "string"},
                            "description": ("List of available Cellosaurus field tags"),
                        },
                    },
                },
                "error": {
...
@register_tool(
    ...
    config={
        ...
        "description": (
            ...
            "using its Cellosaurus accession number (CVCL_ format)."
        ),
        "parameter": {
            "type": "object",
            "properties": {
                ...
                "fields": {
                    ...
                    "items": {"type": "string"},
                    "description": (
                        "Specific fields to retrieve (e.g., ['id', 'ox', "
                        "'char']). If not specified, all fields are returned."
                    ),
                },
            },
            "required": ["accession"],
        ...
        "return_schema": {
            ...
            "properties": {
                ...
                "accession": {
                    "type": "string",
                    "description": "The requested accession number",
                },
                "data": {
                    "type": "object",
                    "description": (
                        "Cell line data (structure depends on format and "
                        "fields requested)"
                    ),
                },
                "format": {
